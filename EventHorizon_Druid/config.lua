...
-- self.config.gcdSpellID = 61304 -- Special GCD spell cd id??
...
-- Feral bars
  ...
  -- Feral Frenzy with Smoldering Frenzy
  self:newSpell({
    requiredTalent = 274837,
    stance = cat,
	playerbuff = 422751, 					
    debuff = {274837,3},
    refreshable = true,
    cooldown = 274837,
    barcolors = {
     playerbuff  = {222/255, 161/255, 050/255, 0.5},
...
-- Restoration bars
  -- Redesign to show only the offensive spells as this looks like it will be more important and I'm not aware of any healer who isn't tracking their HoT's on their party/raid frames.
